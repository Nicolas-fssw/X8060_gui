...
def X8060_XYZ_path(programNumber, laserpath, flowplate):
    ...
    if(flowplate == False):
        pathDict = {
            ...
            '8by12 Jet Channel' : [7680, 13920, 29760, 7680, 38160, 29760, 18680, 13920, 29760, 18680, 38160, 29760, 29680, 13920, 29760, 29680, 38160, 29760, 40680, 13920, 29760, 40680, 38160, 29760]
