...
def X8060_XYZ_path(programNumber, laserpath, flowplate):
    ...
    if(flowplate == False):
        pathDict = {
            ...
            '8by12 Bottom Stack' : [31000, 18360, 35730, 31000, 38360, 35730, 31000, 36360, 35730, 31000, 56360, 35730, 41590, 18360, 35730, 41590, 38360, 35730, 41590, 36360, 35730, 41590, 56360, 35730], 
